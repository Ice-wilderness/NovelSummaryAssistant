# maintainer-runtime-documentation Specification

## Purpose

Define the maintainer documentation contract for current runtime rules, validation entry points, OpenSpec-to-test mapping, and archived change navigation.
