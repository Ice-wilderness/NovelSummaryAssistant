...
- 当前状态：已新增 `docs/stability_audit/` 系列文档，并把 `split-trigger-scan-page`、`harden-frontend-api-upload`、`harden-chapter-splitting-boundaries` 和 `persist-task-terminal-summaries` 归档到 `openspec/changes/archive/`。
...
- 当前 active change：无；最近归档：`openspec/changes/archive/2026-05-27-persist-task-terminal-summaries/`。
